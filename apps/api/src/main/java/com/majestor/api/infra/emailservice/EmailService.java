...
public class EmailService {
    ...
    public CompletableFuture<Void> sendVerificationEmail(String email, String verificationUrl) {
        ...
        String message = "Welcome to Majestor! Please verify your email address to complete your registration and start your academic journey with us.";
        return sendEmail(email, verificationUrl, subject, message);
    }

    @Async
    public CompletableFuture<Void> sendForgotPasswordEmail(String email, String resetUrl) {
        String subject = "Reset Your Password";
        String message = "We received a request to reset your password. Click the button below to create a new password for your account.";
        return sendEmail(email, resetUrl, subject, message);
    }
