          ...
          <div className="card p-8 md:p-12 space-y-8">
            ...
            <section>
              ...
              <div className="mt-4 p-4 bg-[#F0F4FF] rounded-xl space-y-2">
                <p className="text-[#3A6FF8] font-medium">Email: abdullah.zafar.career@gmail.com</p>
                <p className="text-[#3A6FF8] font-medium">General Inquiries: abdullah.zafar.career@gmail.com</p>
              </div>
            </section>
