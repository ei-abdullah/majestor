...
import OfficialGroup from "@/src/components/screens/studyhub/OfficialGroup";
        ...
        <GradientView>
            ...
            >
                <View className="px-6 mb-6">
                    ...
                    <Text className="text-3xl font-bold text-white">Official Faculty Groups</Text>
                    <Text className="text-white/50 text-sm mt-1">Direct channels from your instructors</Text>
                </View>
