                    ...
                    <FlatList
                                ...
                                <View className="bg-mj-bg-light rounded-[32px] border border-mj-blue-50 p-6 shadow-sm">
                                    <View className="flex-row items-start mb-4 justify-between">
                                        ...
                                        <View className="bg-white p-3 rounded-[22px] shadow-sm border border-mj-yellow-100 items-center justify-center min-w-[55px]">
                                            ...
                                            <Text className="text-mj-text-main font-sans-extrabold text-xs mt-1">
                                    ...
                                    <View className="flex-row justify-between items-center px-1">
                                        <View className="flex-row gap-4">
                                            ...
                                            <View className="flex-row items-center">
                                                ...
                                                <Text className="text-mj-text-secondary text-[10px] font-sans-bold uppercase ml-1.5">{item.memberCount} Members</Text>
                                            </View>
                                        </View>
                        ...
                        ListEmptyComponent={
                            <View className="items-center justify-center py-24 opacity-30">
                                ...
                                <Text className="text-mj-text-main font-sans-bold mt-4 uppercase tracking-[2px] text-[10px]">No trending groups</Text>
                            </View>
                        }
                    />
                </Card>
