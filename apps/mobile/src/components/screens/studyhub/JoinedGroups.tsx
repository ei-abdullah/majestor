    ...
    return (
        <View className="mb-6">
            <View className="flex-row justify-between items-center mb-4 px-7">
                <View>
                    <Text style={{color: '#3A6FF8', fontSize: 10, fontWeight: '900', letterSpacing: 2, textTransform: 'uppercase'}}>
                        Your Space
                    </Text>
                        ...
                        >
                            <View style={{
                                ...
                                <View style={{
                                    ...
                                    <Text style={{color: p.text, fontSize: 22, fontWeight: '900'}}>
                                        {group.name.charAt(0).toUpperCase()}
                                    </Text>
                                </View>

                                <View>
                                    <Text style={{color: '#1A2340', fontWeight: '700', fontSize: 14, lineHeight: 19, marginBottom: 8}} numberOfLines={2}>
                                        {group.name}
                                    </Text>
                                    {group.courseName ? (
                                        <View style={{backgroundColor: p.bg, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, alignSelf: 'flex-start', marginBottom: 6}}>
                                            <Text style={{color: p.text, fontSize: 8, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 1}} numberOfLines={1}>
                                                {group.courseName}
                                            </Text>
                                        </View>
                                    ) : (
                                    ...
                                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                        ...
                                        <Text style={{color: '#5A6275', fontSize: 9, fontWeight: '700', marginLeft: 4, opacity: 0.7}}>
