...
export default function JoinedGroupsScreen() {
    ...
    const groups = feedData?.joinedGroups || [];
                            ...
                            >
                                <View className="bg-mj-bg-light rounded-[32px] border border-mj-blue-50 p-6 shadow-sm">
                                    <View className="flex-row items-start mb-4">
                                        <View className="bg-white w-14 h-14 rounded-2xl items-center justify-center mr-4 shadow-sm border border-mj-blue-50">
                                            <Feather name="book-open" size={24} color="#3A6FF8" />
                                        </View>
