...
const PATH_LENGTH = 600; // stroke-dasharray value from CSS

function DrawingRose() {
    const progress = useSharedValue(0);

    useEffect(() => {
        // Animate from 600 (hidden) to 0 (fully drawn) over 10 seconds
        progress.value = withTiming(PATH_LENGTH, {
            duration: 10000,
